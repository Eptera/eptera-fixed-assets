...
class UnicornButton extends FloatingActionButton {
  ...
  UnicornButton(
    ...
    this.hasLabel = false,
          ...
          onPressed: currentButton.onPressed,
    ...
    return Container(
      decoration: BoxDecoration(
          boxShadow: labelHasShadow
              ? [
                  BoxShadow(
                    color: labelShadowColor == null ? const Color.fromRGBO(204, 204, 204, 1.0) : labelShadowColor!,
                    blurRadius: 3.0,
                  ),
                ]
              : null,
          color: labelBackgroundColor == null ? Colors.white : labelBackgroundColor!,
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: labelColor == null ? const Color.fromRGBO(119, 119, 119, 1.0) : labelColor!,
        ),
      ),
    );
  }
...
class _UnicornDialer extends State<UnicornDialer> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _parentController = AnimationController(vsync: this, duration: Duration(milliseconds: widget.mainAnimationDuration));
  ...
  Widget build(BuildContext context) {
    ...
    var hasChildButtons = (widget.childButtons != null && widget.childButtons!.isNotEmpty);
    ...
    var mainFAB = AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          return Transform(
              transform: Matrix4.diagonal3(vector.Vector3(_parentController.value, _parentController.value, _parentController.value)),
    ...
    if (hasChildButtons) {
      var mainFloatingButton = AnimatedBuilder(
          animation: _animationController,
          builder: (BuildContext context, Widget? child) {
            return Transform.rotate(angle: _animationController.value * 0.8, child: mainFAB);
          });
      ...
      var childButtonsList = (widget.childButtons == null || widget.childButtons!.isEmpty)
          ...
          : List.generate(widget.childButtons!.length, (index) {
              ...
              return Positioned(
                ...
                bottom: widget.orientation == UnicornOrientation.VERTICAL ? ((widget.childButtons!.length - index) * 55.0) + 15 : 8.0,
                child: Row(children: [
                  ScaleTransition(
                      ...
                      alignment: FractionalOffset.center,
                      child: ((!widget.childButtons![index].hasLabel) || widget.orientation == UnicornOrientation.HORIZONTAL)
                          ? Container()
                          : Container(
      ...
      return widget.hasBackground
          ? Stack(clipBehavior: Clip.none, alignment: Alignment.topCenter, children: [Positioned(right: -16.0, bottom: -16.0, child: modal), unicornDialWidget])
          : unicornDialWidget;
    }
